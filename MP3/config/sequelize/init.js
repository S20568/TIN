        ...
        .then(customers => {
            if(!customers || customers.length == 0) {
                return Customer.bulkCreate([
                    {customerFirstName: 'Jakub', customerLastName: 'Slusarski', customerEmail: 'kuba@gmail.com', phoneNumber: '+48578964315', password: passHash},
                    {customerFirstName: 'Jan', customerLastName: 'Kowalski', customerEmail: 'jan@gmail.com', phoneNumber: '+48123456789', password: passHash},
                    {customerFirstName: 'Piotr', customerLastName: 'Nowak', customerEmail: 'piotr@gmail.com', phoneNumber: '+48745896123', password: passHash},
                ])
                .then( () => {
                    return Customer.findAll();
                });
